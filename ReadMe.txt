...
The captcha blocked me from progressing so I moved over to the broker site.
...
I also implemented taking screenshots on the physical damage page to test functionality.
